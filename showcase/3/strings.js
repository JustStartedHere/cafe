...
export const STRINGS = {
  ...
  countLabel: { id: 'hidangan', en: 'dishes' },
  ...
  footHours: { id: 'Setiap hari · 08.00 – 21.00', en: 'Every day · 08:00 – 21:00' },
...
export const RESERVE_PREFIX = {
  id: 'Halo, saya ingin memesan dari ',
  en: 'Hello, I would like to order from ',
};
